...
#include "MyProjectXPawn.generated.h"
...
class FUDPMyGameServer;

UCLASS(config=Game)
class AMyProjectXPawn : public AWheeledVehicle
{
	GENERATED_BODY()
...
public:
	...
	UPROPERTY(Category = UDPController, EditAnywhere)
	bool isClientControllerEnable;
...
private:
	...
	void setupUDPController();
	FUDPMyGameServer* UDPMyGameServer;
